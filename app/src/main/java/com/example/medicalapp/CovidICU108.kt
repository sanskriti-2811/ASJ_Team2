...
import com.example.medicalapp.databinding.ActivityCovidIcu108Binding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.FirebaseDatabase

class CovidICU108 : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityCovidIcu108Binding
    private lateinit var firebaseAuth: FirebaseAuth


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCovidIcu108Binding.inflate(layoutInflater)
