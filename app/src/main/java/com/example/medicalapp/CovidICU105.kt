...
import com.example.medicalapp.databinding.ActivityCovidIcu105Binding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.FirebaseDatabase

class CovidICU105 : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityCovidIcu105Binding
    private lateinit var firebaseAuth: FirebaseAuth


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCovidIcu105Binding.inflate(layoutInflater)
