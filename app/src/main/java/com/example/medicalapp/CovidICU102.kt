...
import com.example.medicalapp.databinding.ActivityCovidIcu102Binding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.FirebaseDatabase

class CovidICU102 : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityCovidIcu102Binding
    private lateinit var firebaseAuth: FirebaseAuth


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCovidIcu102Binding.inflate(layoutInflater)
