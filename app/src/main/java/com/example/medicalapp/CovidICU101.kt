...
import com.example.medicalapp.databinding.ActivityCovidIcu101Binding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.FirebaseDatabase

class CovidICU101 : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityCovidIcu101Binding
    private lateinit var firebaseAuth: FirebaseAuth


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCovidIcu101Binding.inflate(layoutInflater)
