...
import com.example.medicalapp.databinding.ActivityCovidIcu107Binding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.FirebaseDatabase

class CovidICU107 : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityCovidIcu107Binding
    private lateinit var firebaseAuth: FirebaseAuth


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCovidIcu107Binding.inflate(layoutInflater)
