...
import com.example.medicalapp.databinding.ActivityCovidIcu100Binding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.FirebaseDatabase

class CovidICU100 : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityCovidIcu100Binding
    private lateinit var firebaseAuth: FirebaseAuth


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCovidIcu100Binding.inflate(layoutInflater)
