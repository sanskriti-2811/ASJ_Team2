...
import com.example.medicalapp.databinding.ActivityCovidIcu109Binding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.FirebaseDatabase

class CovidICU109 : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityCovidIcu109Binding
    private lateinit var firebaseAuth: FirebaseAuth


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCovidIcu109Binding.inflate(layoutInflater)
