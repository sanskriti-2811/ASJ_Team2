...
import com.example.medicalapp.databinding.ActivityCovidIcu104Binding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.FirebaseDatabase

class CovidICU104 : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityCovidIcu104Binding
    private lateinit var firebaseAuth: FirebaseAuth


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCovidIcu104Binding.inflate(layoutInflater)
