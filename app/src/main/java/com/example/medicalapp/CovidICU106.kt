...
import com.example.medicalapp.databinding.ActivityCovidIcu106Binding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.FirebaseDatabase

class CovidICU106 : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityCovidIcu106Binding
    private lateinit var firebaseAuth: FirebaseAuth


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCovidIcu106Binding.inflate(layoutInflater)
