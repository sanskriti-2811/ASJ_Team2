...
import com.example.medicalapp.databinding.ActivityCovidIcu103Binding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.FirebaseDatabase

class CovidICU103 : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityCovidIcu103Binding
    private lateinit var firebaseAuth: FirebaseAuth


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCovidIcu103Binding.inflate(layoutInflater)
