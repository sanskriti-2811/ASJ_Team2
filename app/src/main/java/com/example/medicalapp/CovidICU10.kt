...
import com.example.medicalapp.databinding.ActivityCovidIcu10Binding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.FirebaseDatabase

class CovidICU10 : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityCovidIcu10Binding
    private lateinit var firebaseAuth: FirebaseAuth


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCovidIcu10Binding.inflate(layoutInflater)
